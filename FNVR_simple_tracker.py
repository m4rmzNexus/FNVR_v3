#!/usr/bin/env python3
"""
FNVR Simple Tracker - Minimal pipe-based version
...
class SimpleTrackingApp:
    ...
    def run(self):
        ...
        while True:
            ...
            time.sleep(1.5/60)  # Same as legacy: ~40 FPS
